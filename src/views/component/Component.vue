          ...
          <div class="maintable">
            <div class="top">
              <div class="toplf">
                ...
                <!-- 运维人员使用的按钮，操作。 -->
<!--                <el-button v-if="userId == 4" class="addZJ" size="small" type="primary" icon="el-icon-upload2" @click="appliactionUp">上架</el-button>-->
<!--                <el-button v-if="userId == 4" class="addJM" size="small" type="primary" icon="el-icon-key" @click="applicationAuth">授权</el-button>-->
<!--                <el-button v-if="userId == 4" class="addJM" size="small" type="primary" icon="el-icon-download" @click="applicationDown">下架</el-button>-->
              </div>
              <div class="toprg">
                <el-select
                  size="small"
