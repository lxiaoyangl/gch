                ...
                <div class="appRunningTop">
                  <div class="applicationBox">
                    ...
                    <div class="applicationBoxBottom">
                      ...
                      <img
                        width="18px"
                        :src="require('@/assets/img/开发-正在审批.png')"
                      />
                    </div>
                  </div>
                  <div class="applicationBox">
                    ...
                    <div class="applicationBoxBottom">
                      ...
                      <img
                        width="18px"
                        :src="require('@/assets/img/开发-最近失败.png')"
                      />
                    </div>
                  </div>
                  <div class="applicationBox">
                    ...
                    <div class="applicationBoxBottom">
                      ...
                      <img
                        width="18px"
                        :src="require('@/assets/img/开发-最近成功.png')"
                      />
                    </div>
                  </div>
                </div>
        ...
        <div class="left">
          <div class="applicationRunning">
            ...
            <div class="applicationRunningContent">
              ...
              <!-- <div class="shenpi">
                <div class="shenpiName">审批</div>
                <div class="shenpiNum" style="background: #e7f0f5">
                  <el-image
                    class="shenpiImage"
                    :src="require('@/assets/img/开发-待审批.png')"
                  ></el-image>
                  <el-button class="chakanJd" size="mini" type="primary"
                    >查看进度</el-button
                  >
                  <span class="shenpiNumText">24</span>
                </div>
                <el-divider direction="vertical"></el-divider>
                <div class="shenpiTg">
                  <el-image
                    class="shenpiImage"
                    :src="require('@/assets/img/开发-审批-通过.png')"
                  ></el-image>
                  <el-button class="chakanJd" size="mini" type="text"
                    >审批通过</el-button
                  >
                  <span class="shenpiNumText">24</span>
                </div>
                ...
                <div class="shenpiSb">
                  <el-image
                    class="shenpiImage"
                    :src="require('@/assets/img/开发-审批-失败.png')"
                  ></el-image>
                  <el-button class="chakanJd" size="mini" type="text"
                    >审批失败</el-button
                  >
              ...
              <div class="yichang">
                <div class="yichangName">异常</div>
                <div class="yichangNum">
                  <el-image
                    class="yichangImage"
                    :src="require('@/assets/img/开发-异常.png')"
                  ></el-image>
                  <el-button class="chakanJd" size="mini" type="text"
                    >组件异常</el-button
                  >
                  <span class="yichangNumText">24</span>
                </div>
                <el-divider direction="vertical"></el-divider>
                <div class="componentYc">
                  <el-image
                    class="yichangImage"
                    :src="require('@/assets/img/开发-异常.png')"
                  ></el-image>
                  <el-button class="chakanJd" size="mini" type="text"
                    >组件异常</el-button
                  >
                  <span class="yichangNumText">05</span>
                </div>
                <el-divider direction="vertical"></el-divider>
                <div class="noneContent"></div>
              </div> -->
            </div>
              ...
              <!-- <div class="nearestDataStatus">
                ...
                <div class="nearestDataStatusContent">
                  <div class="businessData common">
                    <el-image
                      :src="require('@/assets/img/开发-运行中.png')"
                    ></el-image>
                    <span class="commonDataName">运行中</span>
                    <span class="commonDataNum">05</span>
                  </div>
                  <div class="processData common">
                    <el-image
                      :src="require('@/assets/img/开发-成功.png')"
                    ></el-image>
                    <span class="commonDataName">成功</span>
                    <span class="commonDataNum">04</span>
                  </div>
                  <div class="achievementData common">
                    <el-image
                      :src="require('@/assets/img/开发-失败.png')"
                    ></el-image>
                    <span class="commonDataName">失败</span>
                    <span class="commonDataNum">02</span>
                  </div>
                </div>
              </div> -->
...
<script>
import ContentChart from "./comp/ContentChart";
import AppCarousel from "./comp/AppCarousel";
import CompCarousel from "./comp/CompCarousel";
export default {
  name: "applicationDevHome",
  components: { ContentChart, CompCarousel, AppCarousel },
  data() {
    return {
      applicationData: [
        {
  ...
  mounted() {},
  methods: {
    appDataMouseleave(index) {
      this.applicationData[index].checkInfo = false;
    },
    appDataMouseenter(index) {
      this.applicationData[index].checkInfo = true;
    },
    getRunImage(status) {
      if (status == 1) {
        return require("@/assets/img/开发-运行中.png");
      }
      if (status == 2) {
        return require("@/assets/img/开发-成功.png");
      }
      if (status == 3) {
        return require("@/assets/img/开发-失败.png");
      }
    },
  },
};
  ...
  .right {
    ...
    .devCommon {
      ...
      &.application {
        .body {
          .appTotal {
            background: url("../../assets/img/开发-应用总数.png") no-repeat
              center;
          }
          .newApp {
            .newAppTop {
              background: url("../../assets/img/开发-应用新建.png") no-repeat
                center;
            }
          }
        }
      ...
      &.component {
        ...
        .body {
          .appTotal {
            background: url("../../assets/img/开发-组件总数.png") no-repeat
              center;
          }
          .newApp {
            .newAppTop {
              background: url("../../assets/img/开发-组件新建.png") no-repeat
                center;
            }
          }
        }
        ...
        .newApp {
          ...
          .newAppTop {
            ...
            div {
              height: 25px;
              width: 25px;
              background: url("../../assets/img/开发-应用新建图标.png")
                no-repeat center;
            }
            span {
              margin-left: 20px;
          ...
          .newAppTop:hover {
            background: url("../../assets/img/开发-应用新建-鼠标.png") no-repeat
              center;
            color: #ffffff;
            div {
              background: url("../../assets/img/开发-应用新建图标白色.png")
                no-repeat center;
            }
          }
          .newAppBottom {
