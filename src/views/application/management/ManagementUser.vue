<template>
  <div class="management">
            ...
            <div class="application" :class="applicationBackGorundClass(item)">
              <div class="applicationDesc">
                ...
                <div style="margin-left: 30px;">
                  <div style="margin-top:7px;"><span :style="{fontSize: '16px',fontWeight: 'bold',minWidth:'70px',color:item.status=='1-3'?'#d65c5c':'#fff'}">{{item.name}}</span><span style="width: 90px;display: inline-block;">【{{item.type}}】</span></div>
              ...
              <div class="applicationBottom">
                ...
                <div class="applicationBottomDesc">
                  ...
                  <div class="body pd" :style="{color: item.status == '1-3' ? '#d65c5c' : '#fff'}">{{item.time}}</div>
                </div>
                <el-divider direction="vertical"></el-divider>
                <div class="applicationBottomDesc">
                ...
                <div class="applicationBottomDesc">
                  ...
                  <div class="body pd" :style="{color: item.status == '1-3' ? '#d65c5c' : '#fff'}">{{item.flowNum}}</div>
                </div>
              </div>
            </div>
            <div class="applicationMaskLayer">
              <el-button size="mini" type="success" @click="openApplicationData()"><i class="el-icon-coin"></i>应用数据</el-button>
              <el-button size="mini" type="warning" @click="applicationRunController()"><i class="el-icon-guide"></i>运行控制</el-button>
              <el-button size="mini" type="primary"><i class="el-icon-right"></i>打开应用</el-button>
              <el-button size="mini" type="primary" @click="openApplicationInstance()"><i class="el-icon-set-up"></i>运行实例</el-button>
            </div>
          </div>
        </div>
      </div>
    ...
    >
      <div class="applicationDataClass">
        <div class="operationToolbar operationToolbarTextClass">
          ...
          <el-button class="mgL20 operationToolbarTextClass" @mouseleave="downloadButtonType = 'text'" @mouseover="downloadButtonType = 'success'" :type="downloadButtonType" icon="el-icon-download">下载</el-button>
          <el-button class="mgL20 operationToolbarTextClass" @mouseleave="deleteButtonType = 'text'" @mouseover="deleteButtonType = 'danger'" :type="deleteButtonType" icon="el-icon-delete">删除</el-button>
        ...
        <div class="searchToolbar">
          <el-row>
            ...
            <el-col :span="16">
              ...
              <el-divider direction="vertical"></el-divider>
              <el-input style="width: 250px" placeholder="输入关键词搜索" suffix-icon="el-icon-search" size="medium" v-model="search_task">
              </el-input>
            </el-col>
          </el-row>
        </div>
    ...
    <el-dialog
      ...
      :before-close="handleClose"
    >
      <div class="applicationRunControllerTitle">
        <span style="color:#5c5cf9;">海南巡航</span>【侦察】
      </div>
