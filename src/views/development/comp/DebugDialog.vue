<template>
  <div>
    <div class="top">
      ...
      >
        ...
        <el-form-item label="保存到">
          C:kugoo <el-link type="primary" :underline="false">更改</el-link>
        </el-form-item>
    ...
    <div class="log">
      调试日志
      <div class="content">
        Lorem, ipsum dolor sit amet consectetur adipisicing elit. Eligendi qui officia at aperiam illo dolore in tenetur perspiciatis iure nisi modi rem, voluptatem voluptate molestias? Sequi repellendus dolor quo architecto?
        {{ logs }}
      </div>
    </div>
  </div>
...
export default {
  ...
  methods: {
    initAntvX6() {
      ...
      this.graph.fromJSON(this.debugData);
    },
  },
  beforeDestroy() {
    this.graph.dispose();
