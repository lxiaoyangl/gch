...
},
{
  ...
  children: [
    ...
    // },
    {
      ...
      component: () => import("@/views/application/management/ManagementUser"),
    },
    {
      name: '流程管理',
...
},
{
  ...
  children: [
    ...
    // {
    //   path: "/applicationManagement/processChoreographer",
    //   name: "流程管理",
    //   component: () => import("../views/applicationManagement/processChoreographer/ProcessChoreographer.vue"),
    // },
    {
